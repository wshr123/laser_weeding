// 简化版 Teensy 3.2 振镜控制器 - V2.4 (修复版)
// 修复内容：
// 1. 自动切换活动振镜 (Auto-Switch Active Galvo)
// 2. 增加端口互换开关 (SWAP_HARDWARE_PORTS)
// 3. 还原 Code 1 协议逻辑 (setBasePosition 参数顺序)
// 4. [CRITICAL] 修复 processSpiral 中的整型溢出问题
